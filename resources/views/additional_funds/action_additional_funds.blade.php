        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Action Additional Funds</h4>
                        </div>
                    </div>
                </div>
                <?php
                ...
                <div class="row h-100">
                    <div class="col-lg-12">
                        <form action="{{ route('update-additional-fund-db')}}" method="post">
                            @csrf
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Update</h4>
                                </div>
                                <input type="hidden" value="{{ $array1->autoadditionalfundid}}" name="autoadditionalfundid">
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <select name="quarter" id="quarter" class="form-control">
                                                    <option value="">Select One</option>
                                                    <option value="1st Quarter" <?php if($array1->additionalfund_quarter== "1st Quarter") echo 'selected';?>>1st Quarter</option>
                                                    <option value="2nd Quarter" <?php if($array1->additionalfund_quarter== "2nd Quarter") echo 'selected';?>>2nd Quarter</option>
                                                    <option value="3rd Quarter" <?php if($array1->additionalfund_quarter== "3rd Quarter") echo 'selected';?>>3rd Quarter</option>
                                                    <option value="4th Quarter" <?php if($array1->additionalfund_quarter== "4th Quarter") echo 'selected';?>>4th Quarter</option>
                                                </select>
                ...
                <div class="row h-100">
                    <div class="col-lg-12">
                        <form action="{{ route('additional-fund-db')}}" method="post">
                            @csrf
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
