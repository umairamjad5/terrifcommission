        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Additional Funds</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form action="{{ route('delete-multiple-additional-fund')}}" method="POST">
                            @csrf
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">List Additional Funds</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="hstack gap-3 fs-15">
                                                            <a href="{{ url('/update_additional_fund/'.$row->autoadditionalfundid)}}" class="link-primary"><i class='uil uil-comment-edit'></i></a>
                                                            {{--<a href="{{ url('/delete_additional_fund/'.$row->autoadditionalfundid)}}" onclick="return confirm('Are you sure')" class="link-danger"><i class='uil-trash-alt'></i></a>--}}
                                                        </div>
                                                    </td>
                                                </tr>  
                                                @endforeach
