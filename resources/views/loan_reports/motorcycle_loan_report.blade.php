            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Motor Cycle Loan Report</h4>
                        </div>
                    </div>
                </div>
                @if(empty($array))
                <div class="row">
                    <div class="col-lg-12 m-auto">
                        <form action="{{ route('motorcycle-loan-report-db')}}" method="POST">
                            @csrf
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Motor Cycle Loan Report</h4>
                                </div>
                                <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Employee Motor Cycle Deduction Report</h4>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>{{ date('F Y',strtotime($row->motorcycle_deduction_month))}}</td>
                                        <td>{{ number_format($row->motorcycle_deduction_amount)}}</td>
                                        <td>{{ number_format($row->motorcycle_deduction_prograssive)}}</td>
                                        <td>{{ number_format($row->motorcycle_deduction_rem_bal)}}</td>
                                    </tr>
                                    @endforeach
                                </table>
                            </div>
