            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Officer Salary Report</h4>
                        </div>
                    </div>
                </div>
                @if(empty($month))
                <div class="row">
                    <div class="col-lg-12 m-auto">
                        <form action="{{ route('officer-salary-report-db')}}" method="POST">
                            @csrf
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Filter Officer Salary Report</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="ExportTable">
                                                <tr>
                                                    ...
                                                    <th class="text-center" colspan="19">Gross Claim</th>
                                                    <th class="text-center" rowspan="2">Total</th>
                                                    <th class="text-center" colspan="11">Deductions</th>
                                                    <th class="text-center" rowspan="2">Net Amount</th>
                                                </tr>
                                                <tr>
                                                    <th class="text-center">Basic Pay</th>
                                                    <th class="text-center">Personal Pay</th>
                                                    <th class="text-center">Special Pay</th>
                                                    ...
                                                    <th class="text-center">Entertainment Allowance</th>
                                                    <th class="text-center">Orderly Allowance</th>
                                                    ...
                                                    <th class="text-center">Mobile phone Allowance</th>
                                                    <th class="text-center">Monetization of Residental Telephone</th>
                                                    <th class="text-center">Additional Charge</th>
                                                    <th class="text-center">Monenization of Transport/ Telephone</th>
                                                    <th class="text-center">Income Tax</th>
                                                    <th class="text-center">Ben. Fund</th>
                                                    <th class="text-center">Group Insurance Fund</th>
                                                    <th class="text-center">G.P. Fund Advance</th>
                                                    <th class="text-center">GP Fund Subscription</th>
                                                    <th class="text-center">MCA Interest</th>
                                                    <th class="text-center">MCA</th>
                                                    <th class="text-center">HBA Interest</th>
                                                ...
                                                <?php
                                                    ...
                                                    ->where('bps_name','>=','16')
                                                    ->where('designation_name','!=','Stenotypist')
                                                ...
                                                @foreach($q as $q)
                                                    <tr>
                                                        <td colspan="34">{{ $q->designation_name}} (BPS-{{ $q->bps_name}})</td>
                                                    </tr>
                                                    <?php
                                                    ...
                                                    @foreach($q1 as $q1)
                                                        ...
                                                        @foreach($q2 as $q2)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if($q2->entertainment_all != 0)
                                                                    {{ number_format($q2->entertainment_all)}}
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @if($q2->orderly_all != 0)
                                                                    {{ number_format($q2->orderly_all)}}
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    @if($q2->utilities != 0)
                                                                    {{ number_format($q2->utilities)}}
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @if($q2->mobile_phone_all != 0)
                                                                    {{ number_format($q2->mobile_phone_all)}}
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @if($q2->monitization_of_residential_telephone != 0)
                                                                    {{ number_format($q2->monitization_of_residential_telephone)}}
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    @if($q2->monitization_of_residential_trasport != 0)
                                                                    {{ number_format($q2->monitization_of_residential_trasport)}}
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    <?php
                                                                        $total_all = $q2->basic_pay + $q2->personal_pay + $q2->special_pay + $q2->qualification_all + $q2->house_rent_all + $q2->conveyance_all + $q2->medical_all + $q2->entertainment_all + $q2->orderly_all + $q2->adhoc_relief + $q2->disparity_reduction_21 + $q2->disparity_reduction_22 + $q2->medical_charges + $q2->special_all + $q2->utilities + $q2->mobile_phone_all + $q2->monitization_of_residential_telephone + $q2->additional_charges + $q2->monitization_of_residential_trasport;
                                                                ...
                                                                <td>
                                                                    @if($q2->motorcar_interest != 0)
                                                                    {{ number_format($q2->motorcar_interest)}}
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <?php
                                                                        $total_all_ded = $q2->income_tax + $q2->ben_fund + $q2->gi_fund + $q2->gpf_adv + $q2->gpf_subs + $q2->motorcar_interest + $q2->motorcar_adv + $q2->hb_interest + $q2->hb_adv + $q2->lfp + $q2->others;
