        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <?php
                    $array = DB::table("employee_motor_cycle_loan_balances")
                    ->get();
                ?>
                @if(empty($array))
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Employee Motor Cycle Balance Report</h4>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ number_format($row->motorcycle_balance_amount)}}</td>
                                    </tr>
                                    @endforeach
                                </table>
                            </div>
