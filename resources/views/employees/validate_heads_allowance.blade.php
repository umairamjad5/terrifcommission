            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Allowances</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 m-auto">
                        <form action="{{ route('add-to-allowances')}}" method="POST">
                            @csrf
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Select Heads For Allowance</h4>
                                </div>
                                    ...
                                    <div class="live-preview">
                                        <div class="row gy-4">
                                            ...
                                            <div class="d-flex align-items-start gap-3 mt-4">
                                                <button type="submit" class="btn btn-success">Enter to Allowances</button>
                                            </div>
                                        </div>
                                        <!--end row-->
                                    </div>
