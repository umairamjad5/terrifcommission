        ...
        <div class="content">
            <div class="container-fluid">
                ...
                if(count($main_query) > 0)
                {
                    ...
                    ->where("autoemployeeid",'=',$main_query->employeeid)
                    ->get();
                ?>
                @if(!empty($query))
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-lg-12">
                                            <table width="100%">
                                                <tr>
                                                    <th width="15%">Name:</th>
                                                    <th width="85%">{{ $query->employee_name}}</th>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <table width="100%">
                                                <?php
                                                    ...
                                                    ->where('employee_allowances.employeeid','=',$main_query->employeeid)
                                                    ->get();
                                                ?>
                                                <tr>
                                                    <td>A01101</td>
                                            ...
                                            <table width="100%" border="1" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <th width="20%">
                                                        <?php
                                                            $gross_claim = '0';
                                                            $emp_allowances = DB::table("employee_allowances")->where('employeeid','=',$main_query->employeeid)->sum('allowance_amount');
                                            ...
                                            <table width="100%">
                                                ...
                                                <?php
                                                    ...
                                                    ->where('employeeid','=',$main_query->employeeid)
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <?php
                                                            $emp_hb_loan = DB::table("employee_h_b_loan_balances")
                                                            ->where('employeeid','=',$main_query->employeeid)
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <?php
                                                            ...
                                                            {
                                                                echo number_format($emp_motorcar_loan_bal);
                                                            }
                                                            else
                                                            {
                                                                echo '-';
                                                    ...
                                                    <td width="20%">
                                                        <?php
                                                            // echo $main_query->employeeid;exit;
                                                            $emp_motorcar_loan = DB::table("employee_motor_car_loans")
                                                            ->where('employeeid','=',$main_query->employeeid)
                                                            ->get();
                                                            if(count($emp_motorcar_loan) > 0)
                                                            {
                                                                foreach($emp_motorcar_loan as $emp_motorcar_loan);
                                                                $motorcar_loan_deduct_amount = $emp_motorcar_loan->motorcar_approved_amount / 60;
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <?php
                                                            $emp_motorcycle_loan = DB::table("employee_motor_cycle_loan_balances")
                                                            ->where('employeeid','=',$main_query->employeeid)
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <?php
                                                            ...
                                                            $all_deduction = $q11->income_tax + $q11->ben_fund + $q11->gi_fund + $q3->gp_fund_advance + $gp_adv_ins + $hb_loan_deduct_amount + $motorcar_loan_deduct_amount + $motorcycle_loan_deduct_amount + $emp_other_deduction_sum;
